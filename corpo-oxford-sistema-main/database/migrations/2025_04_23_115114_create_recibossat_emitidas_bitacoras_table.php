...
class CreateRecibossatEmitidasBitacorasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('recibossat_emitidas_bitacoras', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('recibossat_emitidas_bitacoras');
    }
}
