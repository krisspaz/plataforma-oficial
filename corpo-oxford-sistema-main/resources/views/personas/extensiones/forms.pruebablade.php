        ...
        <div class="tab-pane fade show active" id="datosGenerales" role="tabpanel" aria-labelledby="datosGenerales-tab">
            ...
            <div class="form-group">
                ...
                <label for="{{ $prefix }}[fotografia]">Fotografía</label>
                 <input type="file" class="form-control-file" name="{{ $prefix }}[fotografia]" accept="image/* " onchange="previewImage(event)">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                     ...
                     <label class=" col-form-label" for="{{ $prefix }}[nombres]">Nombres</label>
                    <input type="text" class="form-control" id="nombres" name="{{ $prefix }}[nombres]" value="{{ old($prefix . '.nombres') }}" required>
                </div>
       
                <div class="col-sm-3">
                <label class=" col-form-label" for="{{ $prefix }}[apellidos]">Apellidos</label>

                <input type="text" class="form-control" id="apellidos" name="{{ $prefix }}[apellidos]" value="{{ old(old($prefix . '.apellidos') }}" required>
                </div>
