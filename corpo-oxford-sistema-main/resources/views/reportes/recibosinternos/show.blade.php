...
<div class="box box-default">
    <div class="box-header with-border">
        <h3 class="box-title"><strong>📄 Detalles de Recibos Internos con Serie: {{ $recibos->first()->serie ?? 'N/A' }}</strong></h3>
    ...
    <div class="box-body">
        @foreach ($recibos as $recibo)
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h4 class="box-title">🧾 Recibo Interno #{{ $recibo->numero }}</h4>
                </div>
                <div class="box-body">
                    <div class="row">

                        <div class="col-md-6">
                            <h5 class="text-primary">Información del Recibo Interno</h5>
        ...
        <div class="text-center" style="margin-top: 20px;">
            <a href="{{ route('reportes.recibosinternos.descargarPDF', ['serie' => $recibo->serie]) }}" class="btn btn-success btn-lg" target="_blank">
