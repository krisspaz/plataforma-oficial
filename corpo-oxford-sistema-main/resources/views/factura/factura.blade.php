...
<div class="box">
    ...
    <form action="{{ route('factura.generar') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nit" name="nit"  value="42206669" 
            placeholder="Ingrese el NIT del receptor" required>
        </div>
        <div class="mb-3">
            <label for="cliente" class="form-label">Cliente</label>
            <input type="text" class="form-control" id="cliente" name="cliente" value="Alicia Mariela Guillermo Barrientos" 
            placeholder="Ingrese el nombre del cliente" required>
        </div>
        <div class="mb-3">
            <label for="direccion" class="form-label">Dirección</label>
            <input type="text" class="form-control" id="direccion" name="direccion" value="10 ave. 12-30 Col. San Francisco zona 2, SAN PEDRO CARCHA" required>
        </div>

        <input type="hidden" class="pago-id" name="pago_id[]" >
