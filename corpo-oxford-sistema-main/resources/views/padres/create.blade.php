    ...
    <div class="container">
        ...
        <form action="{{ route('padres.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="identificacion_documentos_id" id="identificacion_documentos_id" class="form-control">
                    @foreach($identificacionDocumentos as $documento)
                        <option value="{{ $documento->id }}" {{ old('identificacion_documentos_id') == $documento->id ? 'selected' : '' }}>{{ $documento->nombre }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input type="text" name="profesion" id="profesion" class="form-control" value="{{ old('profesion') }}">
                @error('profesion')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
