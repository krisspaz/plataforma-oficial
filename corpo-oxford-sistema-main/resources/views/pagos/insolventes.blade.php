...
<div class="panel panel-default">
    <div class="panel-heading d-flex justify-content-between align-items-center">
        <h3>Estudiantes Insolventes</h3>

        {{-- Botón para descargar PDF de todos --}}
        <a href="{{ route('pagos.pdf.todos') }}" class="btn btn-success" target="_blank">
            ...
            @foreach($resultados as $index => $item)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {{-- EXONERAR CUOTAS --}}
                        <a href="{{ route('cuotas.exonerar', $estudiante->id) }}"
                        ...
                        {{-- PDF INDIVIDUAL --}}
                        <form method="GET" action="{{ route('pagos.pdf.estudiante', $estudiante->id) }}" target="_blank">
