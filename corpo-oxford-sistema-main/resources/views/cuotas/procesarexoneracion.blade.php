...
<div class="box">
     <h2 class="box-title">
      Cuotas en Proceso de Exoneración:
       </h2>
    ...
    <div class="box-body">
        ...
        <form id="formExonerar" method="POST" action="{{ route('cuotas.exonerar.proceder') }}">
            @csrf
            ...
            <div class="form-group">
                <label for="estado">Motivo de la Exoneración</label>
                <select name="estado" id="estado" class="form-control">
                    <option value="baja voluntaria">Baja Voluntaria</option>
                    <option value="baja por siniestro">Baja por Siniestro</option>
                    <option value="baja por fuerza mayor">Baja por Fuerza Mayor</option>
                </select>
            </div>
