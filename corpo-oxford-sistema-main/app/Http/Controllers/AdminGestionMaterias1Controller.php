...
class AdminGestionMaterias1Controller extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    public function cbInit()
    {
        ...
        $this->form = [];
        $this->form[] = ['label'=>'Codigo','name'=>'codigo','type'=>'text','validation'=>'min:1|max:255','width'=>'col-sm-10'];
