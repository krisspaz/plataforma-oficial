 ...
 */
final class Version20251205171538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE audit_logs (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, action VARCHAR(100) NOT NULL, entity VARCHAR(100) NOT NULL, entity_id INT DEFAULT NULL, changes JSON DEFAULT NULL, old_data JSON DEFAULT NULL, new_data JSON DEFAULT NULL, severity VARCHAR(20) NOT NULL, user_id INT DEFAULT NULL, user_email VARCHAR(255) DEFAULT NULL, signature VARCHAR(64) NOT NULL, ip VARCHAR(45) DEFAULT NULL, user_agent TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE students (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, birth_date DATE DEFAULT NULL, status VARCHAR(20) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, user_id INT NOT NULL, PRIMARY KEY (id))');
